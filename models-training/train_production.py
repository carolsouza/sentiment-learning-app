...
def train_production_model(data_path="datasets/Reviews.csv"):
    """
    Treina o modelo de produção (BiLSTM) com tracking MLflow
    """
    # Configure MLflow
    ...
    with mlflow.start_run(run_name="production_bilstm64_dnn") as run:
        ...
        # Log hyperparameters
        mlflow.log_param("model_type", "production_bilstm64_dnn")
        ...
        save_path = os.path.join(save_dir, "production_bilstm64_dnn.keras")
...
if __name__ == "__main__":
    model, history, threshold = train_production_model()